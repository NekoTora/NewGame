...
class Club extends Model
{
    ...
    static public function list(){
        return self::where('status',1)->field('id,name,intro,img_logo,status,signup,sort')->select();
    }

    //获取社团信息
    static public function info($id){
        return self::where('id',$id)->field('id,name,intro,img_logo,status,signup,sort')->find();
    }
